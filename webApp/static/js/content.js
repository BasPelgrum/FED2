...
(function(){
	movieApp.content = {
		...
		movies: [
			{	//directives via transparancy voor images.
				title:"Shawshank Redemption", 
				releaseDate:"Release date: <time>14 October 1994</time>", 
				description:"Two imprisoned men bond over a number of years, finding solace and eventual redemption through acts of common decency", 
				cover:"img/shawshank-redemption.jpg"
			}, {
				//directives via transparancy voor images.
				title:"The Godfather", 
				releaseDate:"Release date: <time>24 March 1972</time>", 
				description:"The aging patriarch of an organized crime dynasty transfers control of his clandestine empire to his reluctant son.", 
				cover:"img/the-godfather.jpg"
			}, {
				//directives via transparancy voor images.
				title:"Pulp Fiction", 
				releaseDate:"Release date: <time>14 October 1994</time>", 
				...
				releaseDate:"Release date: <time>18 July 2008</time>", 
				description:"When Batman, Gordon and Harvey Dent launch an assault on the mob, they let the clown out of the box, the Joker, bent on turning Gotham on itself and bringing any heroes down to his level.", 
				cover:"img/the-dark-knight.jpg"
			}]
	};
